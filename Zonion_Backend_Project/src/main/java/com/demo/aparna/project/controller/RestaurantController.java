...
//	@PostMapping(value="/add",  headers = {"content-type=multipart/mixed","content-type=multipart/form-data"})
//	public ResponseEntity<Restaurant> addRestaurant(@RequestBody Restaurant resto,  @RequestParam("file") MultipartFile file) {
//		System.out.println(" In post of resto :  " + resto);
//		Restaurant rest = restaurantService.addResto(resto,file);
//
//		return new ResponseEntity<Restaurant>(rest, HttpStatus.OK);
//	}
//	
